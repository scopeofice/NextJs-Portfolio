...
// Shaders (sphereFragShader and sphereVertShader)
...
const DisplacementSphere = () => {
  ...
  useEffect(() => {
    ...
    const renderer = new THREE.WebGLRenderer({ canvas: canvasRef.current, powerPreference: 'high-performance' });
    ...
    // ... (rest of the code, as provided in the question)
